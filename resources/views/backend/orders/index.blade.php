                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Checkout status</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">So 9 Hai Ba Trung</p>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">1</p>
                                    </td>
