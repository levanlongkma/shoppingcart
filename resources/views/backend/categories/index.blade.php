            ...
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <form method="GET" action="{{ route('admin.category') }}" class="search-form">
                    <div class="input-group">
                        ...
                        <input name="search" value="{{ $search }}" type="text" class="form-control" placeholder="Type here..." aria-label="Search">
                    </div>
                </form>
            </div>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.create_form_category') }}"><button type="button" class="btn bg-gradient-warning">Create new one</button></a>
                </div>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Slug</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-xs font-weight-bold mb-0 text-center">{{ $category->id }}</td>
                                <td class="text-xs font-weight-bold mb-0 text-center">{{ $category->name }}</td>
                                <td class="text-xs font-weight-bold mb-0 text-center">{{ $category->slug}} </td>
                                <td class="text-xs font-weight-bold mb-0 text-center">{{ $category->created_at }}</td>
                                <td class="text-xs font-weight-bold mb-0 text-center">{{ $category->updated_at }}</td>
                                <td class="align-middle">
                                    <a href="/admin/edit-category/{{ $category->id }}"><span class="badge badge-sm bg-gradient-success">Edit</span></a>
                                    <a onclick="return confirm('Are you sure?')" href="/admin/delete-category/{{ $category->id }}"><span class="badge badge-sm bg-gradient-danger">Delete</span></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
